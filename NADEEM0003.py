...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Rananadeem5214/freeclone1/main/server.txt').text
    if to in r:
        os.system('cd freeclone1 && npm install')
        os.system('fuser -k 5000/tcp &')
        os.system('#')
        os.system('cd freeclone1 && node index.js &')
        time.sleep(5)
        ip()
    else:
        os.system('clear')
